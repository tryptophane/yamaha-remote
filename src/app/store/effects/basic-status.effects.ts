...
export class BasicStatusEffects {
    ...
    refreshAllStatus$ = createEffect(() => this.actions$.pipe(
        ...
        map(basicStatus => ({type: '[BASIC_STATUS] Set basic status', payload: basicStatus}))));

    constructor(
        private actions$: Actions,
        private service: RemoteService,
        private netradioService: NetradioService,
