import {NetradioActions, NetRadioActionTypes} from '../actions/netradio.action';
...
export function reducer(state: State = initialState, action: NetradioActions): State {
    switch (action.type) {
        ...
        case NetRadioActionTypes.SET_MENU_STATUS: {
            const newList = Object.assign({}, state.list, {menuStatus: action.payload});
